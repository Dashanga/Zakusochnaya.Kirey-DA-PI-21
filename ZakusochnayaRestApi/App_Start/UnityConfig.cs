...
namespace ZakusochnayaRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, ZakusochnayaDbContext>(new
            HierarchicalLifetimeManager());
            container.RegisterType<IPokupatelService, PokupatelServiceDB>(new
            HierarchicalLifetimeManager());
            container.RegisterType<IElementService, ElementServiceDB>(new
            HierarchicalLifetimeManager());
            container.RegisterType<IOutputService, OutputServiceDB>(new
            HierarchicalLifetimeManager());
            container.RegisterType<ISkladService, SkladServiceDB>(new
            HierarchicalLifetimeManager());
